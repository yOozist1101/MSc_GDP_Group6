...
def main():
    try:
        ...
        # Read data
        input_file = os.path.join(data_dir, 'cleaned_gps_data_Mumbai.csv')  # Configurable
        ...
        # Save results
        output_path = os.path.join(output_dir, "trucks_with_new_states_Mumbai.csv")  # Configurable
