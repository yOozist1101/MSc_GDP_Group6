    ...
    while True:
        try:
            ...
            if choice == "1":
                ...
                data_file = input("Enter training CSV file name (default: trucks_with_new_states_Mumbai.csv): ").strip()
                if not data_file:
                ...
                try:
                    # Check if model files exist in Output directory
                    model_files = [
                        os.path.join(output_dir, "state_classifier.keras"),
                        os.path.join(output_dir, "features_scaler.pkl"),
                        os.path.join(output_dir, "labels_encoder.pkl")
                    ]
                    ...
                    # Load model
                    classifier = VehicleStateClassifier()
                    classifier.load_model(output_dir)
                    ...
                    if test_choice == "1":
                        ...
                        test_file_name = input("Enter test CSV file name: ").strip()
                        ...
                        output_file_name = test_file_name.replace('.csv', '_predictions.csv')
